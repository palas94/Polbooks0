...
public class Proj2 extends Display {
...
double y, lc, cc, nc ;
	 ...
	 public static final String GRAPH = "graph";
	    ...
	    public Proj2() throws FileNotFoundException {
	      ...
	      // set up the renderers
	         ...
	         // draw the "name" label for NodeItems
	          ...
	          FinalRenderer nodeR = new FinalRenderer() ;
	      ...
	      // set up the visual operators
	         ...
	         nEdges.setDefaultColor(ColorLib.rgba(141,238,238,100));
	         ...
	         sim.addForce(new NBodyForce(0.004f, 15f, 0.899f));
	         ...
	         NeighborHighlightControl nhc = new NeighborHighlightControl() ;
	         ...
	         setBackgroundImage("/Users/Apple/Pictures/black-wallpapers.jpeg" , true, true) ;
	    ...
	    private void initDataGroups() throws FileNotFoundException {
	        ...
	        graph.addColumn("scontrol", Integer.class);
	        ...
	        int b[][]=new int[882][2];
	            ...
	            Scanner t = new Scanner(new File("/Users/Apple/Downloads/polbooks(1)/polbooksedge.txt"));
	            ...
	            while (t.hasNextLine()) 
	            {
	            	...
	            	Scanner sc1 = new Scanner(t.nextLine()) ;
	            	sc1.useDelimiter("source");
	            	sc1.next();
	            	Integer first = Integer.parseInt((sc1.next()).trim());
	            	
	            	Scanner sc2 = new Scanner(t.nextLine()) ;
	            	sc2.useDelimiter("target");
	            	sc2.next();
	            	Integer second = Integer.parseInt((sc2.next()).trim());
	           ...
	           System.out.println("The number of triads is " + triad/6);
	           System.out.println("The clustering coefficient is "+ (triad/(6*5460))) ;
	            ...
	            for (int i = 0 ; i < 105 ; i++)
	            {
	            	(graph.getNode(i)).set("scontrol", (graph.getNode(i)).getDegree()) ;
	            }
